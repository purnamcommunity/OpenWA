...
13 install-time patches (29.3). If it exists upstream or in OpenWA, it has a row here.
...
flowchart LR
    ...
    WA --> WLIB["whatsapp-web.js 1.34.7<br/>+ 11 OpenWA patches"]
...
OpenWA ships thirteen exact, self-disabling source transforms over the installed engines. Each runs at
...
This is the patch visibility the matrix cells refer to. Every patch is engine-specific (11 on wwjs,
...
- **13** install-time patches (11 whatsapp-web.js + 2 Baileys), all exact and self-disabling.
