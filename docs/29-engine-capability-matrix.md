...
**Totals:** 114 methods → 228 adapter cells: **202 ✅, 26 ❌** (2 adapter-gaps, 23
...
- **114** interface methods → **228** adapter cells: **202 ✅** / **26 ❌** (2 adapter-gaps, 23
  library-limitations, 0 uncertain), spanning **24** methods.
- Of the 202 ✅ cells, **10 wwjs cells carry an explicit patch dependency** (4 × 🔧² status send,
