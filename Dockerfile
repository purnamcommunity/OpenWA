...
COPY scripts/postinstall.js scripts/patch-wwebjs-201832.js scripts/wwebjs-201832.patch scripts/patch-wwebjs-newsletter-preview.js scripts/patch-wwebjs-status.js scripts/patch-wwebjs-ready-sync.js scripts/patch-wwebjs-participant-arity.js scripts/patch-wwebjs-block.js scripts/patch-wwebjs-group-description.js scripts/patch-wwebjs-call-state.js scripts/patch-wwebjs-call-log-event.js scripts/patch-wwebjs-contact-alt-wid.js scripts/patch-wwebjs-message-secret.js scripts/patch-wwebjs-media-id.js scripts/patch-baileys-appstate.js scripts/patch-baileys-newsletter-create.js ./scripts/
...
RUN npm ci --omit=dev --ignore-scripts \
    ...
    && node scripts/patch-wwebjs-call-state.js \
    && node scripts/patch-wwebjs-call-log-event.js \
    && node scripts/patch-wwebjs-contact-alt-wid.js \
